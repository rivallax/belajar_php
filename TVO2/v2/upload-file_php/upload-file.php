								...
								<div class="card overflow-hidden review-project">
									<div class="card-body">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10">BELAJAR</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
										<p class="tx-12 text-muted mb-3">A project is an activity to meet the creation of a unique product or service and thus activities that are undertaken<br> to accomplish routine activities cannot be considered projects. <a href="">Learn more</a></p>
										<?php
				...
				<div class="panel-body tabs-menu-body p-0 border-0">
					...
					<div class="card-body border-top border-bottom">
						<div class="row">
							...
							<div class="col-4 text-center">
								<a class="" href="signin.html"><i class="dropdown-icon mdi mdi-logout-variant fs-20 m-0 leading-tight"></i></a>
								<div>Sign out</div>
							</div>
						</div>
					</div>
