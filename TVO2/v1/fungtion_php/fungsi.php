            ...
            <div class="ml-3 w-100">
               ...
               <div class="p-2 mt-2 bg-primary d-flex justify-content-between rounded text-white stats">
                <div class="d-flex flex-column">
                    ...
                    <span class="number1">fungtion</span>
                </div>
               </div>
...
<html lang="en">
	<head>
		...
		<!--- Favicon --->
		<link rel="icon" href="../assets/img/gambar perpustakaan.png" type="image/x-icon"/>
								...
								<div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
									...
									<div class="dropdown main-profile-menu nav nav-item nav-link">
										...
										<div class="dropdown-menu">
											...
											<a class="dropdown-item" href="signup.html"><i class="fas fa-sign-out-alt"></i> lOG OUT</a>
										</div>
									</div>
			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					<div class="main-sidebar-header active">
						<a class="desktop-logo logo-light active" href="index.html"><img src="../assets/img/gambar perpustakaan.png" class="main-logo" alt="logo"></a>
						<a class="desktop-logo logo-dark active" href="index.html"><img src="../assets/img/gambar perpustakaan.png" class="main-logo" alt="logo"></a>
					...
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item" href="index.html"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Tampilan Awal</span></a>
							</li>
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">ALL DATA BUKU</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
									<li class="side-menu__label1"><a href="javascript:void(0);">Apps</a></li>
									<li><a class="slide-item" href="tabel-data.html">Komik</a></li>
									<li><a class="slide-item" href="darggablecards.html">Novel</a></li>
									<li><a class="slide-item" href="rangeslider.html">Cerpen</a></li>
									<li><a class="slide-item" href="calendar.html">Lks</a></li>
									<li><a class="slide-item" href="contacts.html">Buku Paket Kelas</a></li>
							...
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">WAKTU</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
									<li class="side-menu__label1"><a href="javascript:void(0);">Apps</a></li>
									<li><a class="slide-item" href="cards.html">Komik</a></li>
									<li><a class="slide-item" href="darggablecards.html">Novel</a></li>
									<li><a class="slide-item" href="rangeslider.html">Cerpen</a></li>
									<li><a class="slide-item" href="calendar.html">Lks</a></li>
									<li><a class="slide-item" href="contacts.html">Buku Paket Kelas</a></li>
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">Hi, Selamat Datang!</h4>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a   href="javascript:void(0);">PERPUSTAKAAN CERIA</a></li>
								</ol>
							</nav>
						</div>
						</div>
					...
					<div class="main-content-body">
						<div class="row row-sm">
							<a href="">
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
									<a href="#dataBuku" class="card overflow-hidden project-card">
										<div class="card-body">
											<div class="d-flex">
												<div class="my-auto">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
								<!-- id -->
								<a href="#PeminjamanBuku" class="card  overflow-hidden project-card">
									<div class="card-body">
										<div class="d-flex">
											<div class="my-auto">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
								<a href="#pengembalianBuku" class="card overflow-hidden project-card">
									<div class="card-body">
										<div class="d-flex">
											<div class="my-auto">
								...
								<div class="card overflow-hidden">
									<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10">DATA BUKU PERTAHUN</h4>
							...
							<div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
								<div class="card overflow-hidden">
									<div class="card-body pb-3">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10">MEMBER FAVORITE</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
						...
						<!-- row -->
						<div class="row row-sm" id="PeminjamanBuku">
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-4">
								<div class="card overflow-hidden">
									<div class="card-header pb-0">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10 mt-2">ESTIMASI PERTAHUN</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
									...
									<div class="card-body">
										...
										<div class="pt-3">
											<div class="row ">
												<div class="col-sm-8 ">
													<h5 class="mb-0 tx-15 d-flex"><span class="legend bg-primary-gradient brround"></span>60.32%</h6>
													<p class="text-muted  tx-13 mb-0">PEMINJAMAN</p>
												</div>
												<div class="col-sm-4 ">
										...
										<div class="pt-3">
											<div class="row ">
												<div class="col-sm-8 ">
													<h6 class="mb-0 tx-15 d-flex"><span class="legend bg-danger-gradient brround"></span>30.73%</h6>
													<p class="text-muted tx-13 mb-0 ">PENGEMBALIAN</p>
												</div>
												<div class="col-sm-4 ">
										...
										<div class="pt-3">
											<div class="row ">
												<div class="col-sm-8 ">
													...
													<p class="text-muted tx-13 mb-0">HILANG</p>
												</div>
												<div class="col-sm-4 ">
							...
							<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
								<div class="card card-dashboard-events">
									<div class="card-header pb-0">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10">BOOK TRENDING</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
									...
									<div class="card-body">
										<div class="list-group ">
											<div class="list-group-item border-top-0">
												...
												<h6>NOVEL 1 Remaja Bercinta</h6>
												<p><strong>8AM - 4PM</strong> Bay Area, San Francisco</p><small><span class="tx-success">trending</span> (3000 book)</small>
											</div>
											<div class="list-group-item">
												<div class="event-indicator bg-danger-gradient"></div><label>Nov 23 <span>Friday</span></label>
												<h6>GENDRE Asia Pacific</h6>
												<p><strong>8AM - 5PM</strong> Singapore</p><small><span class="tx-success">trending</span> (12 tickets left)</small>
											</div>
						...
						<!-- row -->
						<div class="row row-sm" id="dataBuku">
							<div class="col-md-12 col-xl-12">
								<div class="card overflow-hidden review-project">
									<div class="card-body">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10">All DATA BUKU</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
											...
											<table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped ">
												...
												<tbody>
													<tr>
														...
														<td>komik</td>
														<td>01 Jan 2020</td>
														<td><span class="badge bg-success-gradient">Optimal</span></td>
														<td>15 March 2020</td>
													</tr>
													<tr>
														<td>
															<div class="project-contain">
																<h6 class="mb-1 tx-13">RAK II</h6>
															</div>
														</td>
														<td>
													...
													<tr>
														<td>
															<div class="project-contain">
																<h6 class="mb-1 tx-13">RAK III</h6>
															</div>
														</td>
														<td>
														...
														<td>cerpen</td>
														<td>15 March 2020</td>
														<td><span class="badge bg-danger-gradient"> Kurang Baik</span></td>
														<td>15 March 2020</td>
													</tr>
													<tr>
														<td>
															<div class="project-contain">
																<h6 class="mb-1 tx-13">RAK IV</h6>
															</div>
														</td>
														<td>
													...
													<tr>
														...
														<td>All kategori</td>
														<td>15 March 2020</td>
														<td><span class="badge bg-pink-gradient">Baik</span></td>
														<td>15 March 2020</td>
													</tr>
												</tbody>
											</table>
						...
						<div class="row row-sm" id="PeminjamanBuku" >
							...
							<div class="col-xl-4 col-lg-6 col-md-12" id="pengembalianBuku">
								<div class="card overflow-hidden ">
									<div class="card-header pb-0 pt-4">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10 ">Pengembalian</h4>
											<i class="mdi mdi-dots-horizontal text-gray"></i>
										</div>
										...
										<div class="activity Activity-scroll">
											<div class="activity-list">
												...
												<div class="time-activity ">
													...
													<p class="mb-0"><span class="h6 me-1">Adam Berry</span><span class="text-muted tx-13"> Add a new projects</span> 